...
wp_enqueue_style( 'zoepix-styles', str_replace( '/wp', '', site_url() ) . '/wp-content/themes/zoepix/dist/style.css' );

// Load scripts
function add_my_scripts() {
    wp_enqueue_script( 'zoepix-scripts', str_replace( '/wp', '', site_url() ) . '/wp-content/themes/zoepix/dist/bundle.js', array(), '1.0', true );
}
add_action( 'wp_enqueue_scripts', 'add_my_scripts' );

function add_my_script_tags() {
    ?>
    <script src="<?php echo str_replace( '/wp', '', site_url() ); ?>/wp-content/themes/zoepix/dist/bundle.js"></script>
    <?php
}
...
add_filter( 'timber/context', function( $context ) {
    ...
    $site_url_theme = $site_url . '/wp-content/themes/zoepix';
